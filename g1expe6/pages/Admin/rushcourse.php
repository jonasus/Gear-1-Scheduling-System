  ...
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="courses(tabled).html">Courses</a>
          <ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
	...
	<li>
	<img src = "../images/demo/g1titleonly.png" href = "g1">
		<h3>Regular Manual</h3>
		<p>5 hours = ₱3,100</p>
		<p>7 hours = ₱4,100</p>
		<p>8 hours = ₱4,600</p>
        <p>10 hours = ₱5,600</p>
	...
	<li>
	<img src = "../images/demo/innova.png" href = "innova">
		<h3>Innova (Manual)</h3>
		<p>5 hours = ₱3,500</p>
		<p>7 hours = ₱4,900</p>
		<p>8 hours = ₱5,600</p>
	...
	<li>
       <img src = "../images/demo/altis.png" href = "altis">
        <h3>Altis (Automatic)</h3>
		<p>5 hours = ₱4,500</p>
		<p>7 hours = ₱6,300</p>
		<p>8 hours = ₱7,200</p>
        <p>10 hours = ₱9,000</p>
...
<img src = "../images/demo/innova.png" href = "innova">
        ...
        <li>
        <img src = "../images/demo/fortuner.png" href = "fortuner">
