  ...
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li><a class="active"href="/pages/courses.html">Courses</a>
        </li>
      ...
      <div class="scrollable">
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>Gear-1 Course (1-instructor)</td>
              <td>₱2,800 </td>
             <td>₱3,900 </td>
              <td>₱5,500 </td>
              <td>₱8,200 </td>
        ...
        <br />
         <h1>Executive Course: (Pick-up from and drop-off to home or office)</h1>
        <table>
          <thead>
            <tr>
             <th>Course Type</th>
...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_third first">
      <h6 class="heading">Gear1 Driving School</h6>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">Copyright &copy; 2017 - All Rights Reserved - <a href="#">Gear1 Driving School</a></p></p>
    <!-- ################################################################################################ -->
  </div>
</div>
<!-- ################################################################################################ -->
