    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li class = "drop"><a class="clear" href="">Courses</a>
          <ul>
            <li class = "active"><a href="">Manual Course</a></li>
...
<div class="bgded overlay" style="background-color: black">
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <!-- ################################################################################################ -->
      ...
      <li><a href="Normalcourse.php">Normal Course</a></li>
    </ul>
  </div>
</div>
<!-- ################################################################################################ -->
    ...
    <div class="row">
      ...
      <br />  
        ...
        $db = mysqli_connect('localhost', 'root', '', 'gear1');
                $query = "SELECT * FROM tbl_package WHERE transmission_type = 'Manual'";  
                ...
                ?>  
                <ul class="col-md-4">  
                     <form method="post" action="enrollmentpage.php?action=add&id=<?php echo $row["package_id"]; ?>">  
                           <li>
                               <img src="<?php echo $row["package_img"]; ?>" class="img-responsive" /><br />  
