      ...
      <ul class="clear">
        ...
        <li class = "drop"><a class="clear" href="">Courses</a>
          <ul>
            ...
            <li class = "active"><a href="">Automatic Course</a></li>
          </ul>
...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/');">
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <!-- ################################################################################################ -->
      ...
      <li><a href="execcourse.php">Executive Courses</a></li>
    </ul>
  </div>
</div>
<!-- ################################################################################################ -->
    ...
    <div class="row">
      ...
      <br />  
        ...
        $db = mysqli_connect('localhost', 'root', '', 'gear1');
                $query = "SELECT * FROM tbl_package WHERE transmission_type = 'Automatic'";  
                ...
                ?>  
                 <ul class="col-md-4">  
                     <form method="post" action="autocourse.php?action=add&id=<?php echo $row["package_id"]; ?>">  
                           <li>
                               <img href = "" src="<?php echo $row["package_img"]; ?>" class="img-responsive" /><br />  
                               <h4 class="text-info" ><?php echo $row["package_name"]; ?></h4>
                               <h4 class="text-info"><?php echo $row["package_hours"];?> hours</h4>  
                               <h4 class="text-danger">₱ <?php echo $row["package_price"]; ?></h4>  
</li>
                     </form>  
                </ul>  
                <?php  
