...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href=""><img src="../images/demo/g1logo.png"></a></h1>
      </div>
...
<H1>SUPERADMIN PORTAL</H1>
	...
	<div class="content">
		...
		<div class="input-group">
			...
			<select type="text" name="usertype" value="<?php  echo $_SESSION['utype']?>">
        ...
        <div class="input-group">
			<label>Image</label>
			<input type="text" name="image" value="<?php echo $_SESSION['imagee']?>">
		</div>
		<div class="input-group">
					<input type="hidden" name="studid" value="<?php echo $_SESSION['studids']?>"/>
					</div>
		<div class="input-group">
...
$db = "multi_login";
				...
				$result = mysqli_query($con,"SELECT studid,username,email,user_type,image FROM users2"); 
...
$id = $row['studid'];
    ...
    echo "<tr>";
    echo "<td style='width:150px;border:1px solid black;'>" . $row['studid'] . "</td>";
...
<td><button id="edit_btn" type="submit" class="btn" name="select_btn" >Select user</button></td>
<td><input type="hidden" name="studid" value="' . $id . '"/></td></form>';
 echo "</tr>";
}
echo "</table>";
?>
