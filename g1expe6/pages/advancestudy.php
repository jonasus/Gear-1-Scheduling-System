  ...
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <ul>
            <li class = "active"><a href="advancestudy.php">Advance Study</a></li>
...
<br>
      <div id="video">
        <h1>ADVANCE STUDY</h1>
         <br/>
<H2>How To Drive Manual Transmission (video by:Helpful DIY)</H2>
    <video width="765" height="430" controls>
  <source src="../videos/manual.mp4" type="video/mp4">
</video>
<br/> 
     <h2>How To Drive Automatic Transmission (video by:HelpfulDIY)</h2>
     <video width="764" height="430" controls>
  <source src="../videos/matic.mp4" type="video/mp4">
          </video>
      </div>
      <!-- ################################################################################################ -->
      <!-- ################################################################################################ -->
